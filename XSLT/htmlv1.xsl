...
<xsl:transform xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0">
    ...
    <!-- ex: ignore editorial reading -->
    <xsl:template match="expan/ex"></xsl:template>
    
    <!-- am: get original expansions -->
    ...
    <xsl:template match="con_entity">[cg]</xsl:template>
    
    <xsl:template match="septembre_entity">7<sup>bre</sup></xsl:template>
    
    <xsl:template match="octob_entity">[8b]</xsl:template>
    
    <xsl:template match="octobre_entity">8<sup>bre</sup></xsl:template>
    
    <xsl:template match="novemb_entity">[9b]</xsl:template>
    
    <xsl:template match="novembre_entity">9<sup>bre</sup></xsl:template>
    
    <xsl:template match="decembre_entity">10<sup>bre</sup></xsl:template>
